...
const TodoSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'isComplete': IndexSchema(
      id: -2740846684009919309,
      name: r'isComplete',
      unique: false,
      replace: false,
      properties: [
...
extension TodoQueryWhereSort on QueryBuilder<Todo, Todo, QWhere> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhere> anyIsComplete() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'isComplete'),
      );
    });
  }
}
...
extension TodoQueryWhere on QueryBuilder<Todo, Todo, QWhereClause> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> memoIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'memo',
        value: [null],
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> memoIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> memoEqualTo(String? memo) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'memo',
        value: [memo],
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> memoNotEqualTo(String? memo) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> isCompleteEqualTo(
      bool isComplete) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'isComplete',
        value: [isComplete],
      ));
    });
  }

  QueryBuilder<Todo, Todo, QAfterWhereClause> isCompleteNotEqualTo(
      bool isComplete) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> memoIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> memoIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> memoIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'memo',
        value: '',
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> memoIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'memo',
        value: '',
